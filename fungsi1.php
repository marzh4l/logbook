...
<body onload="tampilkanwaktu();setInterval('tampilkanwaktu()', 1000);">
  ...
  <section class="content row">
      <aside class="col-md-2" style="padding-right: 0; height: auto; font-size: medium;">
        <ul class="menu">
          <li><a href="fungsi1.php" class="active"><span class="glyphicon glyphicon-folder-open" style="width: 13%"></span>Buku Tamu</a></li>
          <li><a href="my_account1.php"><span class="glyphicon glyphicon-user" style="width: 13%"></span>Akun Saya</a></li>
    ...
    <section class="main-content col-md-10 text-center">
      ...
      <div class="col-md-2" id="cetak" style="display:<?php if($tampil != "") echo 'block'; else echo 'none'?>;">
        <div class="row">
          <div class="col-md-10" style="text-align: left; padding-top: 5px;"></div>
          <div class="col-md-10" style="text-align: left; padding-top: 5px;"></div>
        </div>
      </div>
      <br/><br/>
        <div class="col-md-10 col-md-offset-1" style="padding-top: 10px;">
          <table class="table table-striped">
            <?php
              if($tampil == 'hari'){
                ?>
                <div class="alert alert-info">Tanggal : <?php echo @$tgl ."<br/>Fungsi : ".$fungsitgl;?></div>
            ...
            <?php
                ...
                $query = @mysqli_query($koneksi,"SELECT pengunjung.id_pengunjung, buku_tamu.asal, pengunjung.nama, buku_tamu.keperluan, buku_tamu.no_visitor, buku_tamu.masuk, buku_tamu.keluar FROM pengunjung, buku_tamu WHERE pengunjung.id_pengunjung = buku_tamu.id_pengunjung AND year(buku_tamu.masuk) = '$exp[2]' AND month(buku_tamu.masuk) = '$exp[1]' AND day(buku_tamu.masuk) = '$exp[0]' AND buku_tamu.fungsi = '$fungsitgl'
              ...
              <tr>
                ...
                ?>
                <div class="alert alert-info">Bulan : <?php echo @$bulan ."<br/>Fungsi : ".$fungsibln;?></div>
                <div class="alert" style="margin-bottom: 0;">Cetak :
                  <a id="link_cetak" target='_black'  href="cetak_pdf_3f.php?<?php
                  if($tampil == "hari") echo 'lap=hari&tgl='.$tgl.'&fungsi='.$fungsitgl;
                  else if($tampil == "bulan") echo 'lap=bulan&bulan='.$bulan.'&fungsi='.$fungsibln;
            ...
            <tbody>
                ...
                $query = @mysqli_query($koneksi,"SELECT pengunjung.id_pengunjung, buku_tamu.asal, pengunjung.nama, buku_tamu.keperluan, buku_tamu.no_visitor, buku_tamu.masuk, buku_tamu.keluar FROM pengunjung, buku_tamu WHERE pengunjung.id_pengunjung = buku_tamu.id_pengunjung AND year(buku_tamu.masuk) = '$exp[1]' AND month(buku_tamu.masuk) = '$exp[0]' AND buku_tamu.fungsi = '$fungsibln'
                ORDER BY buku_tamu.masuk ASC");
                $no = 1;
                while (@$data = mysqli_fetch_array($query)) {
