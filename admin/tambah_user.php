...
<body onload="tampilkanwaktu();setInterval('tampilkanwaktu()', 1000);">
  ...
  <!-- <div class="collapse navbar-collapse navbar-ex1-collapse"> -->
    <ul class="menu dropdown dropdown-fixed-top">
		...
		<li><a href="tambah_user.php" class="active"><span class="glyphicon glyphicon-user" style="width: 13%"></span>Tambah Pengguna</a></li>
    ...
    <section class="main-content col-md-10 text-center">
      ...
      <div class="row" style="margin-top: 30px;">
        <div class="col-md-offset-4 col-md-4" style="background: #e0e3e0;border-radius: 5px; padding-top: 10px;padding-bottom: 30px; border-left: none;">
            <center><h3>Tambah Pengguna</h3></center><br/>
            <form class="form-horizontal" method="post" action="proses_tu.php"  enctype="multipart/form-data">
							<div class="field">
								<label>
									<div>Username</div>
									<input name="username" placeholder="Masukkan Username" required="required" />
								</label>
							...
							<div class="field">
								<label>
									<div>Password</div>
									<input type="password" name="password" data-validate-length-range="6,30" required='required' placeholder="Masukkan password">
								</label>
							...
							<div class="field">
								<label>
									...
									<input type="password" name="password2" data-validate-linked='password' placeholder="Ulangi password" required='required'>
								</label>
							</div>
							<div class="field">
								<label>
									<div>Nama</div>
									<input name="nama" placeholder="Masukkan Nama" required="required" />
								</label>
								<a href="#" data-toggle="tooltip" title="Masukkan nama penanggung jawab fungsi">
									<i class="glyphicon glyphicon-question-sign" style="margin-top: 40px;"></i>
								</a>
							</div>
							<div class="field">
								<label>
									...
									<select name="fungsi" class="form-control" required>
										<?php
											...
											$query = mysqli_query($koneksi,"SELECT * FROM fungsi WHERE fungsi NOT IN (select fungsi from user) ORDER BY id_fungsi ASC");
