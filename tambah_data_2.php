...
<body onload="tampilkanwaktu();setInterval('tampilkanwaktu()', 1000);">
  ...
  <section class="content row">
        ...
        <ul class="menu">
          ...
          <li><a href="tambah_data.php" class="active"><span class="glyphicon glyphicon-plus-sign" style="width: 13%"></span>Tambah Pengenjung</a></li>
					      ...
					      <div class="modal-content">
					        ...
					        <div class="modal-footer">
					          ...
					          <div id="simpan" style="display:none">
					              ...
					              <input class="btn btn-primary" type="button" name="webcam" accept="image/jpg" value="Simpan" onClick="simpan()" data-dismiss="modal" style="font-weight:bold;">
					          </div>
					        </div>
					      </div>
					    </div>
