...
<body onload="tampilkanwaktu();setInterval('tampilkanwaktu()', 1000);">
    ...
    <section class="main-content col-md-10 text-center">
      ...
      <h1>Daftar Pengunjung Belum Keluar</h1>
				<div class="col-md-10 col-md-offset-1" style="text-align:left; font-size:16px; margin-bottom:10px;"><a href="buku_tamu_cs.php" class="btn btn-success"><i class="glyphicon glyphicon-chevron-left"></i>Kembali</a></div>
